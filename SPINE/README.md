...
One-cell notebook runner (loads all modules in memory; writes no `.py` files at runtime):

```bash
cat /Users/jcbn/Desktop/CODEX/SPINE/PROJECT6_SPINE_NOTEBOOK_ONE_CELL.py
```
